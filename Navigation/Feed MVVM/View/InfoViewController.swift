...
class InfoViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    private lazy var titleLabel: UILabel = {
        ...
        titleLabel.textColor = Themes.textColorInversed
    ...
    private lazy var tatooineOrbitalPeriodLabel: UILabel = {
        ...
        tatooineOrbitalPeriodLabel.textColor = Themes.textColorInversed
    ...
    private lazy var showAlertButton: UIButton = {
        ...
        button.setTitleColor(Themes.textColorInversed, for: .normal)
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        view.backgroundColor = Themes.brownColor
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.textColor = Themes.textColor
