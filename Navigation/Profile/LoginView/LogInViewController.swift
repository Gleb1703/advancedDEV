...
// MARK: - SUBVIEWS
    ...
    private lazy var scrollView: UIScrollView = {
        ...
        scrollView.backgroundColor = Themes.backgroundColor
    ...
    private lazy var loginTextField: UITextField = { [unowned self] in
        ...
        loginTextField.textColor = Themes.textColor
    ...
    private lazy var passwordTextField: UITextField = { [unowned self] in
        ...
        passwordTextField.textColor = Themes.textColor
...
//        openProfile() // пропуск авторизации
    ...
    private func setupView() {
        self.view.backgroundColor = Themes.backgroundColor
    }
