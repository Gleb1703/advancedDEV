...
//  Navigation
//
//  Created by Konstantin Bolgar-Danchenko on 08.08.2022.
//
...
class PhotosTableViewCell: UITableViewCell {
    ...
    private lazy var photosTitle: UILabel = {
       let photosTitle = UILabel()
        ...
        photosTitle.textColor = Themes.textColor
        photosTitle.font = UIFont.systemFont(
            ofSize: 24,
            weight: .bold
        )
    ...
    private lazy var photosArrow: UIImageView = {
        ...
        let image = UIImage(
            systemName: "arrow.right")?.withTintColor(Themes.textColor, renderingMode: .alwaysOriginal)
