...
class ProfileHeaderView: UIView {
    ...
    private lazy var fullNameLabel: UILabel = {
        ...
        fullNameLabel.textColor = Themes.textColor
    ...
    private lazy var statusLabel: UILabel = {
        ...
        statusLabel.textColor = Themes.grayColor
    ...
    private lazy var setStatusButton: CustomButton = {
        let setStatusButton = CustomButton(action: buttonPressed,
                                           color: .systemBlue,
                                           title: "Change Status",
                                           titleColor: .white)
    ...
    private lazy var statusTextField: UITextField = {
        ...
        statusTextField.backgroundColor = Themes.textColorInversed
        statusTextField.textColor = Themes.grayColor
